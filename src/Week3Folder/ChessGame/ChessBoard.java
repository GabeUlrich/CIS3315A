...
public class ChessBoard {
     ...
     * chessmen.
     */
    protected ChessBoy[][] board = new ChessBoy[8][8];

    /**
     * When a new chessboard object is created the chessBoy objects are created
     ...
     * @return chessBoy
     */
    public ChessBoy getPiece(String position) {
    ...
    /**
     * Given a position to move from and another to move to, move the chessBoy
     * and replace the empty square with a new empty chessBoy object.
     *
     * @param from
     * @param to
     */
    public void move(String from, String to) {
        ...
        board[rowFrom][colFrom] = new ChessBoy("-");
    }
    ...
    public final void reset() {
        ...
        for (int row = 0; row < tempBoard.length; row++) {
            for (int col = 0; col < tempBoard[row].length; col++) {
                ChessBoy man = new ChessBoy("" + tempBoard[row][col]);
                board[row][col] = man;
            }
        }
    }
